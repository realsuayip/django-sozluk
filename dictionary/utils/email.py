...
def send_email_confirmation(user, to_email):
    ...
    UserVerification.objects.create(
        author=user, verification_token=verification_token_hashed, expiration_date=expiration_date, new_email=to_email
    )
    ...
    return send_mail("email onayı", "email onayı", FROM_EMAIL, [to_email], html_message=msg)
